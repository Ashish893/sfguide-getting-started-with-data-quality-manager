...
st.session_state.databases = ["DATA_QUALITY","AGS_GAME_AUDIENCE","DEMO_DB","GARDEN_PLANTS","INTL_DB","LIBRARY_CARD_CATALOG","MELS_SMOOTHIE_CHALLENGE_DB","MY_ICEBERG_DB","ZENAS_ATHLEISURE_DB","SMOOTHIES"]
